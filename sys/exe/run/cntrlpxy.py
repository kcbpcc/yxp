...
try:
    ...
    total_PnL_percentage_mis_buy = (total_PnL / combined_df_positive_qty['Invested'].sum()) * 100 if (combined_df['product'] == "MIS").any() and combined_df_positive_qty['Quantity'].sum() > 0 else None
    total_PnL_percentage_mis_sell = (total_PnL / combined_df_positive_qty['Invested'].sum()) * 100 if (combined_df['product'] == "MIS").any() and combined_df_positive_qty['Quantity'].sum() < 0 else None
